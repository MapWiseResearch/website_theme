...
<main class="site-main">
  ...
  <section class="archive-head" style="max-width: var(--container); margin: 2rem auto 1.25rem; padding: 0 1rem;">
    <h1 style="margin: 0 0 .35rem 0;">
      <?php single_tag_title(); ?>
    </h1>

    <?php if (!empty($term->description)) : ?>
      <div style="opacity: .75; max-width: 75ch;">
  ...
  <?php else : ?>
    ...
    <p class="search-empty" style="max-width: var(--container); margin: 2rem auto; padding: 0 1rem; text-align:center; opacity:.65;">
      No posts tagged with this yet.
    </p>
